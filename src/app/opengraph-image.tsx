    ...
    (
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: 40 }}>
          <svg viewBox="0 0 32 32" width="120" height="120" style={{ color: '#14110D', marginRight: 30 }}>
        ...
        <div style={{ fontSize: 48, fontWeight: 500, color: '#4a4036', textAlign: 'center', maxWidth: '80%' }}>
