...
export const metadata: Metadata = {
  ...
  description:
    'Hire the minds, not the keystrokes. Proctored One is the sealed, system-monitored workspace for AI-era technical assessments — with line-by-line AI attribution, behavioral signals, and an audit trail.',
